...
class Prob_density {
	...
	public:
		...
		// Constructor.
		Prob_density(const arma::cx_mat& initial, const arma::mat& potential, const double h, const double delta_t);
		...
		// Overloading << operator for Prob_density class. For quick access during debugging.
		friend std::ostream& operator<<(std::ostream& os, const Prob_density& prob);
